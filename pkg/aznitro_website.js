 ...
 * @returns {Promise<any>}
 */
export function fetch_github_repos(username) {
    const ptr0 = passStringToWasm0(username, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fetch_github_repos(ptr0, len0);
    return ret;
}
 ...
 * @returns {string}
 */
export function get_language_color(language) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(language, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_language_color(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_319962be72d27c4a = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_log_f4a4827dc4c73a95 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('aznitro_website_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
